...
import SnackImage from '../../../assets/Diary/Snack.png';
import {
  TitelSection,
  IconMeal,
  TitelMeal,
...
const Snack = () => {
  ...
  return (
    <div>
      <TitelSection>
        <IconMeal src={SnackImage} alt="Snack"></IconMeal>
        <TitelMeal>Snack</TitelMeal>
      </TitelSection>
      ...
      {meals.map((meal) => (
        <div key={meal.id} style={{ maxHeight: '300px', overflowY: 'auto' }}>
          <p>{meal.name}</p>
