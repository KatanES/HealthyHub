...
`,Wt=ae({waterIntake:re().required("Required")}),Ft=({handleModal:n})=>{const o=k(),r=s=>{(s.code==="Escape"||s.currentTarget===s.target)&&n()};l.useEffect(()=>(window.addEventListener("keydown",r),()=>{window.removeEventListener("keydown",r)}));const a=async(s,{resetForm:d})=>{const{waterIntake:i}=s;console.log("Olya",i),o(await M({value:i})),d(),n()};return e.jsx(bt,{onClick:r,children:e.jsxs(wt,{children:[e.jsx(yt,{children:"Add water intake"}),e.jsx(se,{initialValues:{waterIntake:""},validationSchema:Wt,onSubmit:a,children:({errors:s,touched:d})=>e.jsxs(ut,{children:[e.jsx(jt,{htmlFor:"waterIntake",$showIcon:s.waterIntake&&d.waterIntake?"block":"none",children:"How much water"}),e.jsx(kt,{autoFocus:!0,name:"waterIntake",type:"number",min:0,placeholder:"Enter milliliters",borderstyle:s.waterIntake&&d.waterIntake?"1px solid red":""}),e.jsx(de,{name:"waterIntake",children:i=>e.jsx(Ct,{children:i})}),e.jsx(vt,{type:"submit",children:"Confirm"}),e.jsx(It,{type:"button",onClick:n,children:"Cancel"})]})})]})})},zt=t.main`
  padding-top: 16px;
  padding-bottom: 16px;
