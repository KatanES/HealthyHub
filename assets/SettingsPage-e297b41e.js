...
`,Z=i.img`
  width: 100%;
  height: auto;
`,ne=()=>e.jsxs("div",{children:[e.jsx(Q,{children:"Profile setting"}),e.jsxs(N,{children:[e.jsx(X,{children:e.jsx(Z,{src:K,alt:"Settings Hero Image"})}),e.jsx(J,{})]})]});export{ne as default};
