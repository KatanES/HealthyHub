import{u as i,g as t,N as oe,r as c,j as e,a as re,s as ae}from"./index-f5b1a33c.js";import{F as S,a as b,E as y,b as z}from"./index.esm-1a302932.js";import{S as V,Y as se,A as le,B as de,a as pe}from"./YupSchemas-88786f2f.js";import{s as x}from"./symbol-146f83ac.js";import{I as ce}from"./IllustrationDesctop-3bd24af3.js";const xe=i.div`
  width: 300px;
...
`;i.div`
  ...
  margin: 0px 10px 0 0;
  color: ${t.colorSecondaryRed};
`;const Ee=({goNext:m,setGoal:s,dataGoal:a,goBack:g})=>{c.useEffect(()=>{const h='input[type="radio"][value="'+a+'"]',d=document.querySelector(h);d&&(d.checked=!0)},[a]);const l=({goal:h})=>{s(h),m()};return e.jsxs($e,{children:[e.jsx(Pe,{children:e.jsx(Be,{src:Se,alt:"Hiking"})}),e.jsxs(Ce,{children:[e.jsx(Ge,{children:"Your goal"}),e.jsx(ze,{children:"Choose a goal so that we can help you effectively"}),e.jsx(b,{initialValues:{goal:a},validationSchema:se,onSubmit:l,children:e.jsxs(Ae,{children:[e.jsxs(Ie,{role:"group","aria-labelledby":"goalGroup",children:[e.jsxs(E,{children:[e.jsx(N,{type:"radio",name:"goal",value:"1",required:!0}),"Lose Fat"]}),e.jsxs(E,{children:[e.jsx(N,{type:"radio",name:"goal",value:"2",required:!0}),"Maintain"]}),e.jsxs(E,{children:[e.jsx(N,{type:"radio",name:"goal",value:"3",required:!0}),"Gain Muscle"]})]}),e.jsxs(We,{children:[e.jsx(M,{type:"submit",children:"Next"}),e.jsx(M,{type:"button",onClick:g,children:"Back"})]})]})})]})]})},Ne="/HealthyHub/assets/IllustrationGender-a3b492c2.png",Te=i.div`
  width: 300px;
  @media (min-width: 834px) {
    width: 780px;
...
`;i.div`
  ...
  margin: 0px 10px 0 0;
  color: ${t.colorSecondaryRed};
`;const Ke=({goNext:m,goBack:s,setAge:a,setGender:g,dataGender:l,dataAge:h})=>{c.useEffect(()=>{const r='input[type="radio"][value="'+l+'"]',n=document.querySelector(r);n&&(n.checked=!0)},[l]);const d=r=>{const{age:n,gender:o}=r;a(n),g(o.toLowerCase()),m()};return e.jsxs(Te,{children:[e.jsx(Le,{children:e.jsx(Ye,{src:Ne,alt:"Healthy life style"})}),e.jsxs(Fe,{children:[e.jsx(He,{children:"Select gender, Age"}),e.jsx(qe,{children:"Choose a goal so that we can help you effectively"}),e.jsx(b,{initialValues:{gender:l,age:h},validationSchema:le,onSubmit:d,children:({errors:r,touched:n,handleChange:o,handleBlur:u,values:p})=>e.jsxs(S,{autoComplete:"off",children:[e.jsx(Ue,{id:"ageAndGenderGroup",children:"Gender"}),e.jsxs(Re,{role:"group","aria-labelledby":"ageAndGenderGroup",children:[e.jsxs(D,{children:[e.jsx(Q,{type:"radio",name:"gender",value:"Male",required:!0}),"Male"]}),e.jsxs(D,{children:[e.jsx(Q,{type:"radio",name:"gender",value:"Female",required:!0}),"Female"]})]}),e.jsxs("div",{children:[e.jsx(Ve,{children:"Your age"}),e.jsxs(Me,{style:{borderColor:n.age?r.age?"#E74A3B":"#3CBC81":""},children:[e.jsx(De,{type:"number",id:"age",name:"age",placeholder:"Enter your age",onChange:o,onBlur:u,value:p.age,style:{borderColor:n.age?r.age?"#E74A3B":"#3CBC81":""},"aria-label":"Age Input"}),e.jsx(Qe,{style:{display:p.age?"block":"none",position:"absolute",top:"-5%",right:"10px",transform:"translateY(50%)"},children:r.age&&n.age?e.jsx(J,{children:e.jsx("use",{href:x+"#icon-error"})}):e.jsx(J,{children:e.jsx("use",{href:x+"#icon-correct"})})})]}),e.jsx(y,{name:"name",component:G})]}),e.jsxs(Je,{children:[e.jsx(K,{type:"submit",children:"Next"}),e.jsx(K,{type:"button",onClick:s,children:"Back"})]})]})})]})]})},Oe="/HealthyHub/assets/IllustrationBody-f895129d.png",Xe=i.div`
  width: 300px;
  @media (min-width: 834px) {
    width: 780px;
