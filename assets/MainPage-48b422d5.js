import{j as e,r as p,h as V,u as t,g as o,a as k,d as m,e as F,i as T,L as j,k as B,l as A,m as H,n as O,o as Z}from"./index-6c5e21d6.js";import{C as z,a as N,L as Y,B as _,p as q,b as M,c as L,d as U,A as X,D as J}from"./index-e0937cac.js";import{s as E}from"./symbol-e648a0b5.js";import{B as K,L as Q,D as ee,S as te}from"./Snack-cc1a5359.js";import{g as D,r as ie,R as ne}from"./selectors-bf7aa975.js";import{F as oe,b as re,a as ae,E as se}from"./formik.esm-f35d2fae.js";import{c as le,b as de}from"./index.esm-923e3956.js";z.register(N,Y,_,q,M,L);const pe={responsive:!0,aspectRatio:.364,borderRadius:20,scales:{x:{ticks:{display:!1,padding:0},grid:{drawTicks:!1,drawBorder:!1}},y:{beginAtZero:!0,ticks:{display:!1},grid:{drawTicks:!1,drawBorder:!1}}},plugins:{legend:{display:!1},title:{display:!1},tooltip:{enabled:!1}}},ce=["Intake"],xe=({waterIntake:i})=>{const n={labels:ce,datasets:[{label:"Water",data:[i],backgroundColor:"#B6C3FF",hoverBackgroundColor:"#B6C3FF",barPercentage:1.001,categoryPercentage:1.001,grouped:!1},{label:"Dataset 2",data:[100],barPercentage:1.001,categoryPercentage:1.001}]};return e.jsx(e.Fragment,{children:e.jsx(U,{data:n,options:pe})})},he=i=>p.createElement("svg",{width:16,height:16,viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...i},p.createElement("path",{d:"M4 8H12",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),p.createElement("path",{d:"M8 12V4",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),me=V` 
    0% {
...
`,b=i=>{const{title:n,chartBcg:a,elementGoal:s,elementValue:l}=i;let d=s-l;d<0&&(d=0);let r=Math.round(l*100/s);return(r===1/0||isNaN(r))&&(r=0),r>100&&(r=100),e.jsx(e.Fragment,{children:e.jsxs(Ee,{children:[e.jsxs(De,{children:[e.jsx(S,{dailyCalories:s,inputValue:l,chartBcg:a}),e.jsx(Se,{children:e.jsx(Ge,{children:`${r}%`})})]}),e.jsxs(Re,{children:[e.jsx(Ve,{children:n}),e.jsxs(Te,{children:[e.jsxs(Ae,{children:["Goal: ",e.jsx(C,{children:s})]}),e.jsxs(He,{children:["left: ",e.jsx(C,{children:d})]})]})]})]})})},Oe=t.h2`
  color:  ${o.colorPrimaryWhite};
  font-size: 18px;
  font-style: normal;
  font-weight: 400;
...
`;const Ft=le({waterIntake:de().required("Required")}),Bt=({handleModal:i})=>{const n=k(),a=l=>{(l.code==="Escape"||l.currentTarget===l.target)&&i()};p.useEffect(()=>(window.addEventListener("keydown",a),()=>{window.removeEventListener("keydown",a)}));const s=async(l,{resetForm:d})=>{const{waterIntake:r}=l;console.log("Olya",r),n(await B({value:r})),d(),i()};return e.jsx(bt,{children:e.jsx(kt,{onClick:a,children:e.jsxs(jt,{children:[e.jsx(Ct,{children:"Add water intake"}),e.jsx(ae,{initialValues:{waterIntake:""},validationSchema:Ft,onSubmit:s,children:({errors:l,touched:d})=>e.jsxs(vt,{children:[e.jsx(Wt,{htmlFor:"waterIntake",$showIcon:l.waterIntake&&d.waterIntake?"block":"none",children:"How much water"}),e.jsx(It,{autoFocus:!0,name:"waterIntake",type:"number",min:0,placeholder:"Enter milliliters",borderstyle:l.waterIntake&&d.waterIntake?"1px solid red":""}),e.jsx(se,{name:"waterIntake",children:r=>e.jsx(Pt,{children:r})}),e.jsxs($t,{children:[e.jsx(P,{type:"submit",children:"Confirm"}),e.jsx(P,{type:"button",onClick:i,children:"Cancel"})]})]})})]})})})},zt=t.main`
